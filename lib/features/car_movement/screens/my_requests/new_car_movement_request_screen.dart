...
class NewCarMovementRequestScreen extends StatefulWidget {
  ...
  @override
  State<NewCarMovementRequestScreen> createState() =>
      _NewCarMovementRequestScreenState();
}

class _NewCarMovementRequestScreenState
    extends State<NewCarMovementRequestScreen> {
  ...
  void _submitForm() async {
    ...
    String permissionTypeName =
        _permissionTypes[_selectedPermissionType] ?? "N/A";
    // ملاحظات بالاسم الصحيح
    final String notes =
        "طلب $permissionTypeName الموظف $targetUserName عن يوم $prmDateStr من الفترة من $fromTimeStr الى $toTimeStr";
    ...
    if (mounted) {
      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l10n.carMovementRequestSentSuccessfully),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDatePicker(
                      ...
                      validator: (value) => _movementDate == null
                          ? l10n.selectCarMovementDateValidation
                          : null,
                    ),
