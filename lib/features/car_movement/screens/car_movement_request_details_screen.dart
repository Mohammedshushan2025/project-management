...
class CarMovementRequestDetailsScreen extends StatefulWidget {
  ...
  @override
  State<CarMovementRequestDetailsScreen> createState() =>
      _CarMovementRequestDetailsScreenState();
}

class _CarMovementRequestDetailsScreenState
    extends State<CarMovementRequestDetailsScreen> {
  ...
  Future<void> _submitAction(
    ...
    CarMovementRequestItem request,
  ) async {
    final hrProvider = Provider.of<HrProvider>(context, listen: false);
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(
              ...
              _formatDate(request.prmDate, "yyyy-MM-dd"),
            ),
            _buildDetailRow(
