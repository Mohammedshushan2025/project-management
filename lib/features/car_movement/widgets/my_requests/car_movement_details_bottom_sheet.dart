...
class CarMovementDetailsBottomSheet extends StatefulWidget {
  ...
  @override
  State<CarMovementDetailsBottomSheet> createState() =>
      _CarMovementDetailsBottomSheetState();
}

class _CarMovementDetailsBottomSheetState
    extends State<CarMovementDetailsBottomSheet> {
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    l10n.carMovementRequestDetails,
