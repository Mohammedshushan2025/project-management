// lib/features/car_movement/widgets/car_movement_request_card.dart
...
class CarMovementRequestCard extends StatelessWidget {
  final CarMovementRequestItem request;
  final VoidCallback onTap;

  const CarMovementRequestCard({
    super.key,
