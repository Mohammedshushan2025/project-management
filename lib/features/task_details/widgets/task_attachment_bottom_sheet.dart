...
class TaskAttachmentBottomSheet extends StatefulWidget {
  ...
  @override
  State<TaskAttachmentBottomSheet> createState() =>
      _TaskAttachmentBottomSheetState();
}

class _TaskAttachmentBottomSheetState extends State<TaskAttachmentBottomSheet>
  ...
  Future<void> _refreshAttachments() async {
    final provider = Provider.of<DailyTasksProvider>(context, listen: false);
    await provider.getTaskDetailsAttachment(
  ...
  void _showAddAttachmentSheet() async {
    final result = await showModalBottomSheet<bool>(
      ...
      builder: (context) => Padding(
        ...
        child: AddTaskAttachmentBottomSheet(
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DailyTasksProvider>(
      builder: (context, provider, child) {
        ...
        final items =
            provider.taskDetailsAttachmentModel?.items ??
