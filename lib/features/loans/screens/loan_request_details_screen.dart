...
class _LoanRequestDetailsScreenState extends State<LoanRequestDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (hrProvider.selectedLoanRequest != null) {
        hrProvider.loadLoanAuthDetails();
      }
    });
  }
      ...
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (builderContext, setDialogState) {
            ...
            return AlertDialog(
              title: Text(l10n.loanActionDialogTitle),
              content: Column(
  ...
  Widget _buildAuthTimeline(List<LoanAuthItem> authItems) {
    final l10n = AppLocalizations.of(context)!;
    final localeProvider = Provider.of<LocaleProvider>(context, listen: false);
    final isArabic = localeProvider.locale.languageCode == 'ar';
    final locale = localeProvider.locale.toLanguageTag();
  ...
  String _formatDate(String? dateString, String format, String locale) {
    final l10n = AppLocalizations.of(context)!;
