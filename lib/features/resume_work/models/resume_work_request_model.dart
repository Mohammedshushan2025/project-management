...
ResumeWorkRequestList resumeWorkRequestListFromJson(String str) =>
    ResumeWorkRequestList.fromJson(json.decode(str));

class ResumeWorkRequestList {
  final List<ResumeWorkRequestItem> items;
  ResumeWorkRequestList({required this.items});

  factory ResumeWorkRequestList.fromJson(Map<String, dynamic> json) =>
      ResumeWorkRequestList(
        items: List<ResumeWorkRequestItem>.from(
          json["items"].map((x) => ResumeWorkRequestItem.fromJson(x)),
        ),
      );
}
...
class ResumeWorkRequestItem {
  ...
  factory ResumeWorkRequestItem.fromJson(Map<String, dynamic> json) =>
      ResumeWorkRequestItem(
