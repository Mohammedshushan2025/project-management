// lib/features/resume_work/widgets/my_requests/my_resume_work_request_card.dart
...
class MyResumeWorkRequestCard extends StatelessWidget {
  final MyResumeWorkRequestItem request;
  final VoidCallback onTap;

  const MyResumeWorkRequestCard({
    super.key,
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      l10n.resumeWorkRequestDetails, // "تفاصيل طلب مباشرة العمل"
