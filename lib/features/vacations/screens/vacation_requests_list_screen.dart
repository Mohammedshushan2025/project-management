...
class VacationRequestsListScreen extends StatefulWidget {
  ...
  @override
  State<VacationRequestsListScreen> createState() =>
      _VacationRequestsListScreenState();
}

class _VacationRequestsListScreenState
    extends State<VacationRequestsListScreen> {
  @override
  void initState() {
    super.initState();
                ...
                return VacationRequestCard(
                  ...
                  onTap: () async {
                    ...
                    final result = await Navigator.of(
                      context,
                    ).pushNamed(VacationRequestDetailsScreen.routeName);
