...
import '../display_notification_details_view.dart';
    ...
    return DataRow(
      ...
      onSelectChanged: (_) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DisplayNotificationDetailsView(
              userCode: notification.userCode ?? 0,
              altKey: notification.altKey?.toString() ?? '',
