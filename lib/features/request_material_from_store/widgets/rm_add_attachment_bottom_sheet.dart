...
class RMAddAttachmentBottomSheet extends StatefulWidget {
  final bool isArabic;
  final String pk1;
  final String pk2;
  final AttatchmentModel? attachmentData;

  const RMAddAttachmentBottomSheet({
    super.key,
  ...
  @override
  State<RMAddAttachmentBottomSheet> createState() =>
      _RMAddAttachmentBottomSheetState();
}

class _RMAddAttachmentBottomSheetState extends State<RMAddAttachmentBottomSheet>
