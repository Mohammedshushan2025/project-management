// lib/features/employee_transfer/screens/employee_transfer_request_details_screen.dart
...
import '../models/employee_transfer_auth_model.dart';
import '../models/employee_transfer_request_model.dart';
import '../../../core/providers/hr_provider.dart';
import '../../../core/providers/auth_provider.dart';
import '../../../core/providers/locale_provider.dart';
import '../../../core/utils/app_colors.dart';

class EmployeeTransferRequestDetailsScreen extends StatefulWidget {
  static const String routeName = '/employee-transfer-request-details';
...
class _EmployeeTransferRequestDetailsScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (hrProvider.selectedEmployeeTransferRequest != null) {
        hrProvider.loadEmployeeTransferAuthDetails();
      }
    });
  }
      ...
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (builderContext, setDialogState) {
            ...
            return AlertDialog(
              title: Text(l10n.employeeTransferActionDialogTitle),
              content: Column(
  ...
  Future<void> _submitAction(
    ...
    final success = await hrProvider.submitAction(
      ...
      authFlag: authFlag,
      authTableName: 'PY_ORDER_MOVES_H',
      authPk1: request.empCode.toString(),
      authPk2: request.serialPym.toString(),
      authChain: hrProvider.employeeTransferAuthDetails?.items ?? [],
      systemNumber: 63,
      fileSerial: 10,
    );
    if (!mounted) return;
  ...
  Widget _buildHeaderCard(EmployeeTransferRequestItem request) {
    final l10n = AppLocalizations.of(context)!;
  ...
  Widget _buildAuthTimeline(List<EmployeeTransferAuthItem> authItems) {
    final l10n = AppLocalizations.of(context)!;
    final localeProvider = Provider.of<LocaleProvider>(context, listen: false);
    final isArabic = localeProvider.locale.languageCode == 'ar';
