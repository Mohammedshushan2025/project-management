// lib/features/employee_transfer/widgets/my_requests/employee_transfer_details_bottom_sheet.dart
...
import '../../models/my_employee_transfer_request_model.dart';
import '../../../approvals/widgets/auth_timeline_widget.dart'; // Re-use timeline

class EmployeeTransferDetailsBottomSheet extends StatefulWidget {
...
class _EmployeeTransferDetailsBottomSheetState
  ...
  Widget _buildApprovalsSection(HrProvider hrProvider) {
    final l10n = AppLocalizations.of(context)!;
    final authDetails = hrProvider.myEmployeeTransferAuthDetails;
