// lib/features/employee_transfer/widgets/employee_transfer_request_card.dart
...
class EmployeeTransferRequestCard extends StatelessWidget {
  final EmployeeTransferRequestItem request;
  final VoidCallback onTap;

  const EmployeeTransferRequestCard({
    super.key,
