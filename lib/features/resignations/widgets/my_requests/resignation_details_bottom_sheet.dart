...
class ResignationDetailsBottomSheet extends StatefulWidget {
  ...
  @override
  State<ResignationDetailsBottomSheet> createState() =>
      _ResignationDetailsBottomSheetState();
}

class _ResignationDetailsBottomSheetState
    extends State<ResignationDetailsBottomSheet> {
  @override
  void initState() {
    super.initState();
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    hrProvider.isLoading
                        ...
                        : hrProvider.myResignationAuthDetails?.items.isEmpty ??
                              true
                        ? Center(child: Text(l10n.noRegisteredApprovals))
                        : AuthTimeline(
                            authItems:
                                hrProvider.myResignationAuthDetails!.items,
                          ),
                  ],
                ),
              ),
  ...
  Widget _buildDetailsCard() {
    ...
    final reasons = isArabic
        ? widget.request.endReasons
        : (widget.request.endReasons ?? widget.request.endReasons);
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailRow(
              ...
              _formatDate(widget.request.endDate, locale),
            ),
            _buildDetailRow(
              l10n.lastWorkDayLabel,
              _formatDate(widget.request.lastWorkDt, locale),
            ),
