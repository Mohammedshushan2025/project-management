...
class _LoginScreenState extends State<LoginScreen>
  ...
  final Color _secondaryColor = const Color(0xFFAAACD5);
  ...
  Future<void> _fetchCompanies() async {
    ...
    final url = Uri.parse(
      'http://168.119.35.125:7013/TdpSelfServiceWebSrvc-RESTWebService-context-root/rest/V1/SeCompanyVRO1',
    );
    ...
    if (_formKey.currentState!.validate()) {
      if (_selectedCompany == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("يرجى اختيار الشركة أولاً"),
        ...
        return Container(
          child: TextButton(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.language, color: _primaryColor, size: 16),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child: Image.asset(
                                    "assets/images/sharhan_logo.jpeg",
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
