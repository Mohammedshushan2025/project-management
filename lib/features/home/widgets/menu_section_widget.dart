...
class _MenuSectionWidgetState extends State<MenuSectionWidget>
  ...
  final PageController _pageController = PageController(
    ...
    initialPage: 0,
  ); // viewportFraction لجعل جزء من الشريحة التالية ظاهرًا
  int _currentPage = 0;
  Timer? _timer;
    ...
    if (widget.children.length > 1) {
      _timer = Timer.periodic(const Duration(seconds: 5), (Timer timer) {
        ...
        if (_pageController.hasClients) {
          // التأكد أن الـ controller متصل بـ PageView
  ...
  Widget build(BuildContext context) {
    ...
    return FadeTransition(
      ...
      child: SlideTransition(
        ...
        child: Column(
          // استخدام Column لوضع العنوان فوق الـ SlideShow
                    ...
                    children: [
                      Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontWeight:
                              FontWeight.w600, // أقل سمكًا قليلاً من bold
                ...
                itemBuilder: (context, index) {
                  ...
                  return Transform.scale(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: ClipRRect(
                        // لضمان أن المحتوى لا يتجاوز الحدود الدائرية
                        borderRadius: BorderRadius.circular(
                          11.0,
                        ), // أقل بقليل من حدود الكارت
