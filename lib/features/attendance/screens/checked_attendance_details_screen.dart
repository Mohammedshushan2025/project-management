...
class CheckedAttendanceDetailsScreen extends StatefulWidget {
  ...
  @override
  State<CheckedAttendanceDetailsScreen> createState() =>
      _CheckedAttendanceDetailsScreenState();
}

class _CheckedAttendanceDetailsScreenState
    extends State<CheckedAttendanceDetailsScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<AttendanceProvider>(
        context,
        listen: false,
      ).fetchCheckedMonthDetails(widget.monthUrl);
    });
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: DataTable(
                  ...
                  rows: provider.checkedDetails
                      .map((day) => _buildDataRow(day))
                      .toList(),
                ),
              ),
            ),
  ...
  DataRow _buildDataRow(CheckedAttendanceDetailItem day) {
    ...
    final Color rowColor = isSpecialDay
    ...
    return DataRow(
      ...
      cells: [
        DataCell(
          Text(
            day.taDate != null ? DateFormat('MM/dd').format(day.taDate!) : '-',
          ),
        ),
        DataCell(Text(dayName ?? '-')),
        DataCell(
          Text(
            formatTime(day.revIn),
