// lib/features/salary_confirmation/widgets/my_requests/salary_confirmation_details_bottom_sheet.dart
...
class _SalaryConfirmationDetailsBottomSheetState
  ...
  Widget _buildApprovalsSection(HrProvider hrProvider) {
    final l10n = AppLocalizations.of(context)!;
    final authDetails = hrProvider.mySalaryConfirmationAuthDetails;
