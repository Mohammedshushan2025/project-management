// lib/features/salary_confirmation/widgets/salary_confirmation_request_card.dart
...
class SalaryConfirmationRequestCard extends StatelessWidget {
  final SalaryConfirmationRequestItem request;
  final VoidCallback onTap;

  const SalaryConfirmationRequestCard({
    super.key,
